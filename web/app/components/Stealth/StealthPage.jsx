...
import StealthLeftPanel from "./StealthLeftPanel";
...
@connectToStores
class StealthPageWrapper extends React.Component {
    ...
    render () {
        ...
        return <StealthPage {...this.props} account_name={account_name} />
    }
}
export default StealthPageWrapper;